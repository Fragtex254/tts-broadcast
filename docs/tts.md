...
source: "https://platform.xiaomimimo.com/docs/zh-CN/usage-guide/speech-synthesis"
author:
published:
created: 2026-05-28
...
| **音色名** | **voice** **参数** |
| --- | --- |
| MiMo-默认 | mimo\_default |
| MiMo-中文女声 | default\_zh |
| MiMo-英文女声 | default\_en |
