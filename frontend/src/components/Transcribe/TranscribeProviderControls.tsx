    ...
    <>
      <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2" aria-label="整理方式">
        <button
          ...
          className={`rounded-2xl border p-3 text-left transition-ui duration-150 disabled:opacity-40 ${
          ...
          {wslEngine === 'qwen' ? (
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3.5 py-2.5 bg-lilac hover:brightness-105 disabled:opacity-40 text-ink rounded-xl shadow-btn font-body text-[12px] transition-ui duration-150 whitespace-nowrap"
              >
