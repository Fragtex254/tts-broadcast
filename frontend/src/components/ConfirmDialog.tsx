      ...
      footer={(
        <div className="flex items-center justify-end gap-3">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className="px-5 py-2 bg-pink text-ink font-body text-[12px] font-medium rounded-full shadow-btn active:translate-y-0 active:shadow-none hover:brightness-105 ui-transition disabled:opacity-40"
          >
