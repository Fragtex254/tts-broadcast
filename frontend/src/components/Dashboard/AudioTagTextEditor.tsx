...
const DropSlot: React.FC<DropSlotProps> = ({ position, isSelected, onDropSnippet, onSelect }) => {
  ...
  return (
    <button
      ...
      className={`h-8 w-2 shrink-0 rounded-full border transition-ui duration-150 ${
        isOver || isSelected
      ...
      <div className="flex flex-wrap gap-2">
        {group.tags.map((tag) => (
          <button
            ...
            className={`rounded-full px-3 py-1.5 font-body text-[12px] text-ink transition-ui duration-150 hover:-translate-y-px hover:brightness-105 ${
        ...
        <div className="flex shrink-0 gap-2">
            ...
            {onSuggest && (
              <button
                ...
                className="rounded-xl bg-lilac px-4 py-2 font-body text-[13px] font-medium text-ink shadow-btn transition-ui duration-150 hover:brightness-105 disabled:opacity-40"
              >
            ...
            <button
              type="button"
              onClick={onClose}
              className="rounded-xl bg-sage px-4 py-2 font-body text-[13px] font-medium text-ink shadow-btn transition-ui duration-150 hover:brightness-105"
            >
              完成
            </button>
        </div>
