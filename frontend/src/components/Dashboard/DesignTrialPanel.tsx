    ...
    <div className="flex flex-col gap-4 animate-fade-in">
      <div className="flex items-center justify-between gap-3 rounded-2xl border border-card-border bg-white/65 px-4 py-3">
        ...
        <button
          ...
          className="shrink-0 rounded-xl bg-lilac px-4 py-2.5 font-body text-[13px] font-medium text-ink shadow-btn transition-ui duration-150 hover:brightness-105"
        >
          打开面板
        </button>
      </div>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 bg-lilac hover:brightness-105 disabled:opacity-40 text-ink font-body font-medium text-[14px] rounded-2xl px-4 py-3 shadow-btn transition-ui duration-150 flex items-center justify-center gap-2"
        >
          {isTrialLoading ? (
            <>
        ...
        <button
          ...
          className="bg-sage hover:brightness-105 disabled:opacity-40 text-ink font-body font-medium text-[14px] rounded-2xl px-5 py-3 shadow-btn transition-ui duration-150"
        >
          保存预设
        </button>
      </div>
        ...
        <div className="bg-white/70 rounded-2xl p-5 border border-card-border animate-fade-in">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <button
              ...
              className="bg-sage hover:brightness-105 disabled:opacity-40 text-ink font-body font-medium text-[14px] rounded-xl px-4 py-2.5 shadow-btn transition-ui duration-150"
            >
              {isSaving ? '保存中...' : '保存'}
            </button>
          </div>
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <button
                    ...
                    className="rounded-xl bg-lilac px-4 py-2.5 font-body text-[13px] font-medium text-ink shadow-btn transition-ui duration-150 hover:brightness-105 disabled:opacity-40"
                  >
