...
|-------|---------|---------|--------------|------|
| backend-route | 路由端点 | BACKEND「路由/错误处理/参数校验/响应格式」 | 2026-07-11 | ⚠️ 213 行，略超体量阈值，后续考虑拆分 |
| backend-service | 服务/外部 API | BACKEND「服务层规范」+ CLAUDE 健壮性2/4 | 2026-07-11 | ✅ |
| backend-database | schema/迁移/DAL | BACKEND「数据库规范」+ CLAUDE 迁移规范 | 2026-07-11 | ✅ |
...
| frontend-state-data | 状态/数据流 | FRONTEND「状态管理/API/防抖/Settings」+ CLAUDE 健壮性1/3 | 2026-07-11 | ✅ |
